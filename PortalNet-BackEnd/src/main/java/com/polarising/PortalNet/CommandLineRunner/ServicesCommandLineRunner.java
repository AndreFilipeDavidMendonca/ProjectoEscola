...
public class ServicesCommandLineRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		serviceRepository.save(new Services("Blue Master 3", "", "200", "",
				"5", 8, 45, "01-01-2019", true, "assets/img/servicesBackground2.png", "servicesBackground2.png"));
		serviceRepository.save(new Services("Blue Master 4", "200", "", "5000",
				"", 0, 30, "01-01-2019", true, "assets/img/servicesBackground3.png", "servicesBackground3.png"));
