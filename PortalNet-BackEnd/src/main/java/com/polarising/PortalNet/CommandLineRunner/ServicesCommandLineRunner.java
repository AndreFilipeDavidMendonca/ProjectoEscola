...
public class ServicesCommandLineRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		serviceRepository.save(new Services("Blue Master 1", "0", "200", "5",
				"5000", 1, 100, "01-01-2019", true, "assets/img/servicesBackground0.png", "servicesBackground0.png"));
		serviceRepository.save(new Services("Blue Master 2", "50", "100", "3",
				"6000", 1, 60, "01-01-2019", true, "assets/img/servicesBackground1.png", "servicesBackground1.png"));
		serviceRepository.save(new Services("Blue Master 3", "0", "200", "2",
				"Minutos Ilimitados", 1, 45, "01-01-2019", true, "assets/img/servicesBackground2.png", "servicesBackground2.png"));
		serviceRepository.save(new Services("Blue Master 4", "200", "0", "1",
				"Minutos Ilimitados", 1, 30, "01-01-2019", true, "assets/img/servicesBackground3.png", "servicesBackground3.png"));
		serviceRepository.save(new Services("Blue Master 5", "200", "10", "1000",
